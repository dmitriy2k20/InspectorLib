...
namespace InspectorLib
{
    ...
    {
        string[] FCs = { "Иванов И.И.", "Зиронов Т.А.", "Миронов А.В.", "Васильев В.И." };//Список сотрудников
        string[] FCsFullName = { "Васильев Василий Иванович" };//ФИО главного инспектора
        ...
        public void AddWorker()//6 метод добавляет нового сотрудника
        {
            ...
            FCs[FCs.Length - 1] = worker;//Изменяем размер массива
